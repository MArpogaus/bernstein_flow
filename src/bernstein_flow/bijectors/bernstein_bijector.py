...
class BernsteinBijector(tfb.Bijector):
    ...
    def gen_inverse_interpolation(self) -> None:
        ...
        print('self.z_min.shape:', self.z_min.shape)
        print('self.z_max.shape:', self.z_max.shape)
    ...
    def _forward(self, y: tf.Tensor) -> tf.Tensor:
        ...
        print('y.shape:', y.shape)
        print('beta_dist_h.batch_shape:', self.beta_dist_h.batch_shape)
